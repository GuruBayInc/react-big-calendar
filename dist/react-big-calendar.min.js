!(function(e, t) {
      ...
      return (
        ...
        (t.prototype.render = function() {
          ...
          var S = v.title(o),
            ...
            x = v.start(o),
            j = v.allDay(o),
            T = c || j || Xe(x, Be(M, 'day'), 'day') > 1,
            P = m.eventProp(o, x, M, a),
            k = r.createElement(
              'div',
          ...
          return r.createElement(
            ...
            r.createElement(
              ...
              i({}, D, {
                tabIndex: 0,
                style: i({}, P.style, t),
                className: G('rbc-event', n, P.className, {
                  'rbc-selected': a,
                  'rbc-event-allday': T,
  ...
  function In(e) {
    return e instanceof zn(e).Element || e instanceof Element
  }
  function Wn(e) {
    return e instanceof zn(e).HTMLElement || e instanceof HTMLElement
  }
  function Hn(e) {
    return (
      'undefined' != typeof ShadowRoot &&
      (e instanceof zn(e).ShadowRoot || e instanceof ShadowRoot)
    )
  }
  function Un(e, t) {
  ...
  function Yn(e) {
    return (
      (In(e) ? e.ownerDocument : e.document) || window.document
    ).documentElement
  }
  function $n(e) {
    return 'html' === Vn(e)
      ? e
      : e.assignedSlot || e.parentNode || (Hn(e) ? e.host : null) || Yn(e)
  }
  function Xn(e) {
    return Wn(e) && 'fixed' !== Bn(e).position ? e.offsetParent : null
  }
  function qn(e) {
    for (var t = zn(e), n = Xn(e); n && Kn(n) && 'static' === Bn(n).position; )
      n = Xn(n)
    return n &&
      ('html' === Vn(n) || ('body' === Vn(n) && 'static' === Bn(n).position))
      ? t
      : n ||
          (function(e) {
  ...
  var or = { top: 'auto', right: 'auto', bottom: 'auto', left: 'auto' }
  function ar(e) {
    var t,
      n = e.popper,
      r = e.popperRect,
      ...
      u =
        !0 === l
          ? (function(e) {
              ...
              return { x: Qn(Qn(t * r) / r) || 0, y: Qn(Qn(n * r) / r) || 0 }
            })(a)
          : 'function' == typeof l
          ? l(a)
          : a,
    ...
    var D,
      S = Object.assign({ position: i }, c && or)
    return s
      ? Object.assign(
          {},
          S,
  ...
  var ir = { passive: !0 }
  var sr = { left: 'right', right: 'left', bottom: 'top', top: 'bottom' }
  function cr(e) {
  ...
  function pr(e) {
    return Fn(Yn(e)).left + fr(e).scrollLeft
  }
  function dr(e) {
    var t = Bn(e),
      n = t.overflow,
  ...
  function hr(e, t) {
    ...
    var r = (function e(t) {
      ...
      a = zn(r),
      i = o ? [a].concat(a.visualViewport || [], dr(r) ? r : []) : r,
      s = t.concat(i)
    return o ? s : s.concat(hr($n(i)))
  }
  function vr(e) {
          ...
          (function(e) {
            ...
            return (
              'rtl' === Bn(o || n).direction &&
                (s += Zn(n.clientWidth, o ? o.clientWidth : 0) - a),
    ...
    var r =
        'clippingParents' === t
          ? (function(e) {
              var t = hr($n(e)),
                n =
                  ['absolute', 'fixed'].indexOf(Bn(e).position) >= 0 && Wn(e)
                    ? qn(e)
                    : e
              return In(n)
                ? t.filter(function(e) {
                    return In(e) && Un(e, n) && 'body' !== Vn(e)
                  })
                : []
            })(e)
          : [].concat(t),
      ...
      i = o.reduce(function(t, n) {
        var r = mr(e, n)
        return (
          (t.top = Zn(r.top, t.top)),
          (t.right = Jn(r.right, t.right)),
          (t.bottom = Jn(r.bottom, t.bottom)),
          (t.left = Zn(r.left, t.left)),
          t
        )
      }, mr(e, a))
    return (
  ...
  function wr(e, t) {
    ...
    var n = t,
      ...
      d = n.padding,
      h = void 0 === d ? 0 : d,
      v = tr('number' != typeof h ? h : nr(h, On)),
      m = u === Pn ? kn : Pn,
      g = e.elements.reference,
      y = e.rects.popper,
      b = e.elements[p ? m : u],
      w = gr(In(b) ? b : b.contextElement || Yn(e.elements.popper), i, c),
      E = Fn(g),
      _ = br({ reference: E, element: y, strategy: 'absolute', placement: o }),
      D = vr(Object.assign({}, y, _)),
      S = u === Pn ? D : E,
      O = {
        ...
        (('body' !== Vn(t) || dr(a)) &&
          (c =
            (r = t) !== zn(r) && Wn(r)
              ...
              : fr(r)),
        Wn(t)
          ? (((l = Fn(t)).x += t.clientLeft), (l.y += t.clientTop))
          : a && (l.x = pr(a))),
      {
        ...
        u = {
          ...
          forceUpdate: function() {
            if (!l) {
              ...
              if (xr(t, n)) {
                ;(s.rects = {
                  reference: Sr(t, qn(n), 'fixed' === s.options.strategy),
                  popper: Ln(n),
                }),
                  (s.reset = !1),
      ...
      },
      {
        ...
        effect: function(e) {
          var t = e.state,
            ...
            i = r.resize,
            s = void 0 === i || i,
            c = zn(t.elements.popper),
            l = [].concat(t.scrollParents.reference, t.scrollParents.popper)
          return (
            a &&
              l.forEach(function(e) {
                e.addEventListener('scroll', n.update, ir)
              }),
            s && c.addEventListener('resize', n.update, ir),
            function() {
              a &&
                l.forEach(function(e) {
                  e.removeEventListener('scroll', n.update, ir)
                }),
                s && c.removeEventListener('resize', n.update, ir)
            }
          )
        },
        data: {},
          ...
          if (_) {
            if (a || s) {
              var x = 'y' === w ? wn : Dn,
                ...
                B = t.elements.arrow && qn(t.elements.arrow),
                ...
                X = _[w] + V - Y
              if (a) {
                var q = er(d ? Jn(k, $) : k, P, d ? Zn(N, X) : N)
                ;(_[w] = q), (M[w] = q - P)
              }
              if (s) {
                var G = 'x' === w ? wn : Dn,
  ...
  var Yr = r.forwardRef(function(e, n) {
    var a = e.flip,
      c = e.offset,
      l = e.placement,
  ...
  var Xr,
    qr = Function.prototype.bind.call(Function.prototype.call, [].slice)
  function Gr(e, t) {
    if (!Xr) {
      var n = document.body,
        r =
  ...
  function Zr(e, t, n) {
    return void 0 === n && (n = document), Lr(n, e, t, { passive: !1 })
  }
  function Jr(e, t) {
    var n = t.clientX,
      r = t.clientY
  ...
  var to = (function() {
    ...
    return (
      ...
      (t.isSelected = function(e) {
        ...
        return !(!t || !this.selecting) && no(t, ro(e))
      }),
      (t.filter = function(e) {
    ...
    return (
      ...
      (o._selectable = function() {
        var e = this,
          ...
          r = (this._selector = new to(this.props.container, {
            longPressThreshold: this.props.longPressThreshold,
          })),
          o = function(r, o) {
            if (!Qr(n.findDOMNode(e), r)) {
              var a = ro(t),
                i = e.props,
                s = i.range,
                c = i.rtl
  ...
  ;(lo.propTypes = {}), (lo.defaultProps = i({}, io))
  ...
  var ho,
    vo = Qe['__core-js_shared__'],
    mo = (ho = /[^.]+$/.exec((vo && vo.keys && vo.keys.IE_PROTO) || ''))
      ? 'Symbol(src)_1.' + ho
      : ''
  ...
  var bo = /^\[object .+?Constructor\]$/,
    wo = Function.prototype,
    Eo = Object.prototype,
    _o = wo.toString,
    Do = Eo.hasOwnProperty,
    So = RegExp(
      '^' +
        _o
          .call(Do)
  ...
  function Oo(e) {
    return (
      !(!ut(e) || ((t = e), mo && mo in t)) && (vt(e) ? So : bo).test(yo(e))
    )
    var t
  }
  function Mo(e, t) {
  ...
  ;(Ao.prototype.clear = function() {
    ...
    (Ao.prototype.has = function(e) {
      var t = this.__data__
      return jo ? void 0 !== t[e] : ko.call(t, e)
    }),
    (Ao.prototype.set = function(e, t) {
      var n = this.__data__
      return (
        (this.size += this.has(e) ? 0 : 1),
        (n[e] = jo && void 0 === t ? No : t),
        this
      )
    }),
    ...
    (Co.prototype.delete = function(e) {
  ...
  var $o = 1,
    ...
    aa = '[object DataView]',
    ia = et ? et.prototype : void 0,
    sa = ia ? ia.valueOf : void 0
  function ca(e, t) {
  ...
  var ga = Object.prototype,
    ...
    wa = ma(
      ...
      ? ma
      : function(e) {
          return Mt(e) && ya.call(e, 'callee') && !ba.call(e, 'callee')
        }
  var Ea = 'object' == typeof e && e && !e.nodeType && e,
    _a =
      Ea && 'object' == typeof module && module && !module.nodeType && module,
    Da = _a && _a.exports === Ea ? Qe.Buffer : void 0,
    Sa =
  ...
  ;(Oa['[object Float32Array]'] = Oa['[object Float64Array]'] = Oa[
    '[object Int8Array]'
  ] = Oa['[object Int16Array]'] = Oa['[object Int32Array]'] = Oa[
    '[object Uint8Array]'
  ] = Oa['[object Uint8ClampedArray]'] = Oa['[object Uint16Array]'] = Oa[
    '[object Uint32Array]'
  ] = !0),
    (Oa['[object Arguments]'] = Oa['[object Array]'] = Oa[
      '[object ArrayBuffer]'
    ] = Oa['[object Boolean]'] = Oa['[object DataView]'] = Oa[
      '[object Date]'
    ] = Oa['[object Error]'] = Oa['[object Function]'] = Oa[
      '[object Map]'
    ] = Oa['[object Number]'] = Oa['[object Object]'] = Oa[
      '[object RegExp]'
    ] = Oa['[object Set]'] = Oa['[object String]'] = Oa[
      '[object WeakMap]'
    ] = !1)
  var xa = 'object' == typeof e && e && !e.nodeType && e,
    ja =
      xa && 'object' == typeof module && module && !module.nodeType && module,
    Ta = ja && ja.exports === xa && Ze.process,
    Pa = (function() {
      try {
    ...
    ka = Pa && Pa.isTypedArray,
    Na = ka
      ? Ma(ka)
      : function(e) {
          return Mt(e) && gt(e.length) && !!Oa[lt(e)]
        },
  ...
  function Fa(e) {
    ...
    return e === (('function' == typeof t && t.prototype) || Ca)
  }
  function La(e, t) {
    return function(n) {
      return e(t(n))
  ...
  var Ba = Mo(Qe, 'DataView'),
    ...
    Ja = yo($a),
    Qa = lt
  ;((Ba && '[object DataView]' != Qa(new Ba(new ArrayBuffer(1)))) ||
    (xo && '[object Map]' != Qa(new xo())) ||
    (Ka && '[object Promise]' != Qa(Ka.resolve())) ||
    (Ya && '[object Set]' != Qa(new Ya())) ||
    ($a && '[object WeakMap]' != Qa(new $a()))) &&
    (Qa = function(e) {
      var t = lt(e),
  ...
  function ii(e, t, n, r, o, a) {
        ...
        i || Na(e)
          ...
          : (function(e, t, n, r, o, a, i) {
              switch (n) {
                ...
                case oa:
                  return !(
                    e.byteLength != t.byteLength || !a(new Bo(e), new Bo(t))
                  )
                case qo:
                case Go:
                case Qo:
    ...
    if (!(n & ti)) {
      var d = u && ai.call(e, '__wrapped__'),
        h = f && ai.call(t, '__wrapped__')
      if (d || h) {
        var v = d ? e.value() : e,
          m = h ? t.value() : t
        return a || (a = new Lo()), o(v, m, n, r, a)
      }
    }
    return (
      !!p &&
      ...
      (function(e, t, n, r, o, a) {
        var i = n & Ua,
          s = Ha(e),
          c = s.length
        if (c != Ha(t).length && !i) return !1
        for (var l = c; l--; ) {
          var u = s[l]
          if (!(i ? u in t : Va.call(t, u))) return !1
        }
        var f = a.get(e),
          p = a.get(t)
            ...
            (function(e, t, n, r) {
              ...
              for (; ++o < a; ) {
                ...
                if (i && s[2]) {
                  ...
                  if (!(void 0 === p ? si(u, l, ci | li, r, f) : p)) return !1
                }
              }
              return !0
            })(n, e, t)
  ...
  function vi(e, t) {
    ...
    return (
      ...
      hi.test(e) || !di.test(e) || (null != t && e in Object(t))
    )
  }
  ...
  function gi(e, t) {
    ...
    return (n.cache = new (gi.Cache || Co)()), n
  }
  gi.Cache = Co
  var yi = 500
  var bi,
  ...
  var Mi = 1 / 0,
    xi = et ? et.prototype : void 0,
    ji = xi ? xi.toString : void 0
  function Ti(e) {
    if ('string' == typeof e) return e
    if (la(e)) return Oi(e, Ti) + ''
    if (jt(e)) return ji ? ji.call(e) : ''
    var t = e + ''
    ...
    return vi(e) && ui(t)
      ...
      : function(n) {
          var r = (function(e, t, n) {
            var r = null == e ? void 0 : Ai(e, t)
            return void 0 === r ? n : r
          })(n, e)
          return void 0 === r && r === t ? Ci(n, e) : si(t, r, Fi | Li)
        }
  }
  function Ii(e) {
    return e
  ...
  function Ki(e, t) {
    ...
    for (n = 0; n < e.length; n++) {
      for (o = e[n], r = 0; r < a.length && $i(o, a[r]); r++);
  ...
  var Zi,
    Ji = function(e, t, n) {
      return (
        ...
        (function(e, t, n, r) {
          for (
            var o = -1, a = Gi(qi((t - e) / (n || 1)), 0), i = Array(a);
            a--;

          )
            (i[r ? a : ++o] = e), (e += n)
          return i
        })(e, t, (n = void 0 === n ? (e < t ? 1 : -1) : Ft(n)), Zi)
      )
    },
    Qi = function(e, t) {
    ...
    ts = (function(e) {
      ...
      return (
          ...
          for (
            ...
            if (u) {
              ...
              if (this.canRenderSlotEvent(f, d)) {
                var v = so(this.props, u)
                h && s.push(co(n, h, c + '_gap')),
                  s.push(co(n, d, c, v)),
                  (i = a = p + 1)
              } else
                h && s.push(co(n, h, c + '_gap')),
                  s.push(co(n, 1, c, this.renderShowMore(t, a))),
                  (i = a += 1)
            } else a++
          }
        ...
        (n.canRenderSlotEvent = function(e, t) {
          ...
          return Ji(e, e + t).every(function(e) {
            return 1 === es(n, e)
          })
        }),
  ...
  ;(ts.propTypes = {}), (ts.defaultProps = i({}, io))
  var ns = function(e) {
      var t = e.children
      return r.createElement(
        'div',
  ...
  function os(e, t) {
    ...
    for (var n = 0; n < e.length; n++)
      if (((r = e[n]), (o = t[n]), !(r === o || (rs(r) && rs(o))))) return !1
    var r, o
    return !0
  }
  function as(e, t) {
  ...
  var cs = (function(e) {
    ...
    return (
      (o.getRowLimit = function() {
        var e = $r(this.eventRow),
          t = this.headingRow ? $r(this.headingRow) : 0,
          r = $r(n.findDOMNode(this)) - t
          ...
          r.createElement(
            ...
            r.createElement(
              ...
              r.createElement(
                ...
                i({ isAllDay: S }, N),
                j.map(function(e, t) {
                  return r.createElement(lo, i({ key: t, segments: e }, N))
                }),
                !!T.length &&
                  r.createElement(
                    ts,
  ...
  ;(cs.propTypes = {}), (cs.defaultProps = { minRows: 0, maxRows: 1 / 0 })
  var ls = function(e) {
    var t = e.label
    return r.createElement(
      'span',
        ...
        return (
          ...
          (t.renderWeek = function(e, n) {
            var o = t.props,
              ...
              y = m.rowLimit
            return (
              (a = ps(a, e[0], e[e.length - 1], d)).sort(function(e, t) {
                return Xi(e, t, d)
              }),
              r.createElement(cs, {
                key: n,
          ...
          (t.readerDateHeading = function(e) {
            var n = e.date,
              ...
              m = t.props.components.dateHeader || us
            return r.createElement(
              'div',
              i({}, a, {
  ...
  var ys = et ? et.isConcatSpreadable : void 0
  function bs(e) {
    return la(e) || wa(e) || !!(ys && e && e[ys])
  }
  ...
  function xs(e, t, n) {
    return (
      (t = Ms(void 0 === t ? e.length - 1 : t, 0)),
      function() {
        for (
          var r = arguments, o = -1, a = Ms(r.length - t, 0), i = Array(a);
          ++o < a;
  ...
  var As = (function(e) {
    ...
    return function() {
      var r = Ns(),
        o = ks - (r - n)
      if (((n = r), o > 0)) {
        if (++t >= Ps) return arguments[0]
      } else t = 0
      return e.apply(void 0, arguments)
    }
  })(Ts)
  function Rs(e, t) {
    return As(xs(e, t, Ii), e + '')
  }
  var Cs = Rs(function(e, t) {
      if (null == e) return []
      var n = t.length
      return (
        n > 1 && _t(e, t[0], t[1])
  ...
  var Hs = (function(e) {
    ...
    return (
      ...
      (t.prototype.render = function() {
        ...
        return r.createElement(
          'div',
          i({ className: 'rbc-timeslot-group' }, p),
          o.map(function(e, o) {
            var a = s && !f ? s.slotProp(e, n) : {}
            return r.createElement(
              u,
      ...
      N = i(
        ...
        g
          ? (((t = {
              ...
              height: Us(x),
              width: 'calc(' + T + ' + 10px)',
            })[l ? 'right' : 'left'] = Us(Math.max(0, P))),
            t)
          : (((n = { top: Us(j), width: Us(T), height: Us(x) })[
              l ? 'right' : 'left'
            ] = Us(P)),
            n)
      )
        ...
        return (
          ...
          (t._selectable = function() {
            var e = n.findDOMNode(ae(t)),
              ...
              a = function(n) {
                var r = t.slotMetrics.closestSlotFromPoint(n, ro(e))
            ...
            r.on('selecting', o),
              ...
              r.on('beforeSelect', function(e) {
                if ('ignoreEvents' === t.props.selectable)
                  return !Qr(n.findDOMNode(ae(t)), e)
              }),
              r.on('click', function(e) {
                return s(e, 'click')
              }),
  ...
  ;($s.propTypes = {}),
    ($s.defaultProps = { dragThroughEvents: !0, timeslots: 2 })
  var Xs,
    qs = (function(e) {
      function t() {
  ...
  function Zs(e) {
    if (((!Xs && 0 !== Xs) || e) && nn) {
      ...
      ;(t.style.position = 'absolute'),
        ...
        (Xs = t.offsetWidth - t.clientWidth),
    ...
    return (
      ...
      (n.render = function() {
        var e = this,
          ...
          w = t.resizable,
          E = {}
        v && (E[o ? 'marginLeft' : 'marginRight'] = Zs() + 'px')
  ...
  var tc = (function(e) {
    function t(t) {
      ...
      return (
        ...
        (o.memoizedResources = as(function(e, t) {
          return (function(e, t) {
            return {
              map: function(n) {
                return e
      ...
      return (
        ...
        (t.prototype.render = function() {
          var e = this.props,
            ...
            o = s(e, nc),
            a = t.range(n)
          return r.createElement(tc, i({}, o, { range: a, eventOffset: 10 }))
        }),
        t
      )
    })(r.Component)
    ...
    ac = (function(e) {
      ...
      return (
        ...
        (t.prototype.render = function() {
          ...
          return r.createElement(tc, i({}, o, { range: a, eventOffset: 15 }))
        }),
        t
      )
    })(r.Component)
  ;(ac.propTypes = {}),
    (ac.defaultProps = tc.defaultProps),
    (ac.navigate = function(e, t) {
      switch (t) {
        case Z.PREVIOUS:
          return be(e, -1, 'week')
        case Z.NEXT:
    ...
    (ac.range = function(e, t) {
      var n = t.localizer.startOfWeek()
      return Ke(Ee(e, 'week', n), _e(e, 'week', n))
    }),
    (ac.title = function(e, t) {
      var n = t.localizer,
        r = ac.range(e, { localizer: n }),
        o = r[0],
        a = r.slice(1)
  ...
  var ic = ['date']
  function sc(e, t) {
    return ac.range(e, t).filter(function(e) {
      ...
      return (
        ...
        (t.prototype.render = function() {
          var e = this.props,
            ...
            n = s(e, ic),
            o = sc(t, this.props)
          return r.createElement(tc, i({}, n, { range: o, eventOffset: 15 }))
        }),
        t
      )
    })(r.Component)
  ...
  function fc(e) {
        ...
        if (v.current) {
          ...
          if (t) {
            var n,
              ...
              a = [],
              i = a
            ;(a = [Gs(t.children[0]), Gs(t.children[1])]),
              (i[0] === a[0] && i[1] === a[1]) ||
              ...
              o
                ? ((r = 'rbc-header-overflowing'),
                  ...
                  (e.style.marginRight = Zs() + 'px'))
                : (function(e, t) {
                    e.classList
                      ? e.classList.remove(t)
                      : 'string' == typeof e.className
                      ? (e.className = uc(e.className, t))
                      : e.setAttribute(
                          'class',
                          uc((e.className && e.className.baseVal) || '', t)
                        )
    ...
    return (
      (u = u.filter(function(e) {
        return Yi(e, Ee(l, 'day'), _e(b, 'day'), a)
      })).sort(function(e, t) {
                    ...
                    w.map(function(e, t) {
                      return (function(e, t, c) {
                        ...
                        return (t = t.filter(function(t) {
                          return Yi(t, Ee(e, 'day'), _e(e, 'day'), a)
                        })).map(function(s, f) {
                          var p = a.title(s),
                            d = a.end(s),
                            h = a.start(s),
  ...
  ;(lc.propTypes = {}),
    (lc.defaultProps = tc.defaultProps),
    (lc.range = sc),
    (lc.navigate = ac.navigate),
    ...
    (fc.propTypes = {}),
    (fc.defaultProps = { length: 30 }),
    (fc.range = function(e, t) {
      var n = t.length
      return {
        start: e,
        end: be(e, void 0 === n ? fc.defaultProps.length : n, 'day'),
      }
    }),
    (fc.navigate = function(e, t, n) {
      var r = n.length,
        o = void 0 === r ? fc.defaultProps.length : r
      switch (t) {
        case Z.PREVIOUS:
          return be(e, -o, 'day')
        case Z.NEXT:
    ...
    (fc.title = function(e, t) {
      var n = t.length,
        r = void 0 === n ? fc.defaultProps.length : n,
        o = t.localizer,
        a = be(e, r, 'day')
  ...
  var pc =
      ...
      (cc[J.AGENDA] = fc),
      cc),
    dc = ['action', 'date', 'today']
  function hc(e, t) {
    var n = t.action,
      r = t.date,
      o = t.today,
      a = s(t, dc)
    switch (((e = 'string' == typeof e ? pc[e] : e), n)) {
      case Z.TODAY:
        r = o || new Date()
        break
      case Z.DATE:
  ...
  function gc(e, t, n) {
    '__proto__' == t && js
      ? js(e, t, { configurable: !0, enumerable: !0, value: n, writable: !0 })
      : (e[t] = n)
  }
  vc.propTypes = {}
  ...
  function bc(e, t, n) {
    var r = e[t]
    ;(yc.call(e, t) && Ge(r, n) && (void 0 !== n || t in e)) || gc(e, t, n)
  }
  function wc(e, t, n, r) {
    var o = !n
    n || (n = {})
    for (var a = -1, i = t.length; ++a < i; ) {
      ...
      void 0 === c && (c = e[s]), o ? gc(n, s, c) : bc(n, s, c)
    }
    return n
  }
  ...
  function _c(e) {
    ...
    var t = Fa(e),
      n = []
    for (var r in e) ('constructor' != r || (!t && Ec.call(e, r))) && n.push(r)
    return n
  }
  function Dc(e) {
    return yt(e) ? Ra(e, !0) : _c(e)
  }
  var Sc = 'object' == typeof e && e && !e.nodeType && e,
    Oc =
      Sc && 'object' == typeof module && module && !module.nodeType && module,
    Mc = Oc && Oc.exports === Sc ? Qe.Buffer : void 0,
    xc = Mc ? Mc.allocUnsafe : void 0
  var jc = La(Object.getPrototypeOf, Object),
    Tc = Object.getOwnPropertySymbols
      ? function(e) {
          for (var t = []; e; ) ca(t, ha(e)), (e = jc(e))
          return t
        }
      : fa
  function Pc(e) {
  ...
  var Ac = /\w*$/
  var Rc = et ? et.prototype : void 0,
    Cc = Rc ? Rc.valueOf : void 0
  ...
  function tl(e, t, n) {
    ...
    switch (t) {
      ...
      case Wc:
        return (
          ((a = new (o = e).constructor(o.source, Ac.exec(o))).lastIndex =
            o.lastIndex),
          a
        )
      case Hc:
        return new i()
      case Vc:
        return (r = e), Cc ? Object(Cc.call(r)) : {}
    }
  }
  ...
  function yl(e, t, n, r, o, a) {
        ...
        if (
          ((i =
            c || p
              ? {}
              : (function(e) {
                  return 'function' != typeof e.constructor || Fa(e)
                    ? {}
                    : rl(jc(e))
                })(e)),
          !s)
    ...
    var h = u ? void 0 : (l ? (c ? Pc : Ha) : c ? Dc : Wa)(e)
    return (
      mc(h || e, function(r, o) {
        h && (r = e[(o = r)]), bc(i, o, yl(r, t, n, o, e, a))
      }),
      i
    )
  }
  function bl(e, t) {
    return (
      null ==
        (e = (function(e, t) {
          return t.length < 2 ? e : Ai(e, qe(t, 0, -1))
        })(e, (t = Pi(t, e)))) ||
      delete e[
        Ni(((n = t), (r = null == n ? 0 : n.length), r ? n[r - 1] : void 0))
      ]
    )
    var n, r
  }
  ;(gl[dl] = gl['[object Array]'] = gl['[object ArrayBuffer]'] = gl[
    '[object DataView]'
  ] = gl['[object Boolean]'] = gl['[object Date]'] = gl[
    '[object Float32Array]'
  ] = gl['[object Float64Array]'] = gl['[object Int8Array]'] = gl[
    '[object Int16Array]'
  ] = gl['[object Int32Array]'] = gl['[object Map]'] = gl[
    '[object Number]'
  ] = gl[ml] = gl['[object RegExp]'] = gl['[object Set]'] = gl[
    '[object String]'
  ] = gl['[object Symbol]'] = gl['[object Uint8Array]'] = gl[
    '[object Uint8ClampedArray]'
  ] = gl['[object Uint16Array]'] = gl['[object Uint32Array]'] = !0),
    (gl['[object Error]'] = gl[hl] = gl['[object WeakMap]'] = !1)
  var wl = '[object Object]',
    El = Function.prototype,
    _l = Object.prototype,
    Dl = El.toString,
    Sl = _l.hasOwnProperty,
    Ol = Dl.call(Object)
  function Ml(e) {
    return (function(e) {
      if (!Mt(e) || lt(e) != wl) return !1
      var t = jc(e)
      if (null === t) return !0
      var n = Sl.call(t, 'constructor') && t.constructor
      return 'function' == typeof n && n instanceof n && Dl.call(n) == Ol
    })(e)
      ? void 0
      : e
  }
  function xl(e) {
    return (null == e ? 0 : e.length) ? ws(e, 1) : []
  }
  var jl = (function(e) {
      return As(xs(e, void 0, xl), e + '')
    })(function(e, t) {
      var n = {}
      if (null == e) return n
      var r = !1
    ...
    kl = Rs(function(e, t) {
      ...
      for (o && _t(t[0], t[1], o) && (r = 1); ++n < r; )
        for (var a = t[n], i = Dc(a), s = -1, c = i.length; ++s < c; ) {
          var l = i[s],
            u = e[l]
          ;(void 0 === u || (Ge(u, Tl[l]) && !Pl.call(e, l))) && (e[l] = a[l])
        }
      return e
    })
  var Nl = function(e) {
    ...
    Al = ['view', 'date', 'getNow', 'onNavigate'],
    Rl = [
      'view',
      'toolbar',
      'toolbarProps',
      ...
      return (
          ...
          return Array.isArray(o)
            ? (function(e, t, n) {
                ...
                if (((t = Hi(t)), null == n)) {
                  ...
                  n = o ? (r ? new a() : []) : ut(e) && vt(a) ? rl(jc(e)) : {}
                }
                return (
                  (o ? mc : _s)(e, function(e, r, o) {
                    return t(n, e, r, o)
                  }),
                  n
                )
        ...
        (t.handleNavigate = function(e, n) {
          var r = t.props,
            ...
            p = c()
          l(
            (a = hc(f, i({}, u, { action: e, date: n || a || p, today: p }))),
            o,
            e
          ),
    ...
    return (
      ...
      (n.render = function() {
        var e = this.props,
          ...
          m = e.showMultiDayTimes,
          g = e.onShowMore,
          y = e.doShowMoreDrillDown,
          b = (e.components, e.formats, e.messages, e.culture, s(e, Rl))
        d = d || h()
        var w = this.getView(),
          ...
          M = E.viewNames,
          x = D.toolbar || vc,
          j = w.title(d, { localizer: O, length: v })
        return r.createElement(
          'div',
          i({}, p, {
            className: G(f, 'rbc-calendar', b.rtl && 'rbc-rtl'),
            style: u,
          }),
          n &&
            r.createElement(
  ...
  ;(Fl.defaultProps = {
    elementProps: {},
    toolbarProps: { hidePrevious: !1, hideNext: !1 },
    popup: !1,
    toolbar: !0,
    view: J.MONTH,
  ...
  var Ll = (function e(t, n, o) {
    ...
    })(Fl, { view: 'onView', date: 'onNavigate', selected: 'onSelectEvent' }),
    zl = function(e, t, n) {
      var r = e.start,
        o = e.end
    ...
    Il = {
      ...
      dayFormat: 'DD ddd',
      weekdayFormat: 'ddd',
      selectRangeFormat: zl,
      eventTimeRangeFormat: zl,
  ...
  var Wl = function(e, t, n) {
    ...
    Hl = {
      ...
      dayFormat: 'ddd dd/MM',
      weekdayFormat: 'ddd',
      selectRangeFormat: Wl,
      eventTimeRangeFormat: Wl,
      eventTimeRangeStartFormat: function(e, t, n) {
        var r = e.start
  ...
  var Kl = function(e, t, n) {
    ...
    $l = { eventWrapper: a, timeSlotWrapper: a, dateCellWrapper: a }
  ;(e.Calendar = Ll),
    (e.DateLocalizer = ne),
    (e.Navigate = Z),
    (e.Views = J),
