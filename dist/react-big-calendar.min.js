!(function(e, t) {
  ...
  function $e(e) {
    return 0 === Re(e) && 0 === Ae(e) && 0 === Ne(e) && 0 === Pe(e)
  }
  function Xe(e, t, n) {
          ...
          return r.createElement(
            ...
            r.createElement(
              ...
              i({}, D, {
                tabIndex: 0,
                style: i({}, k.style, t),
                className: G('rbc-event', n, k.className, {
                  'rbc-selected': a,
                  'rbc-event-allday': T,
          ...
          if (_) {
            if (a || s) {
              var x = 'y' === w ? wn : Dn,
                ...
                X = _[w] + V - Y
              if (a) {
                var q = er(d ? Jn(P, $) : P, k, d ? Zn(N, X) : N)
                ;(_[w] = q), (M[w] = q - k)
              }
              if (s) {
                var G = 'x' === w ? wn : Dn,
  ...
  ;(Ao.prototype.clear = function() {
    ...
    (Ao.prototype.has = function(e) {
      var t = this.__data__
      return jo ? void 0 !== t[e] : Po.call(t, e)
    }),
    ...
    return (
      ...
      ),
      {
        ...
        dateIsInGroup: function(e, t) {
          var r = p[t + 1]
          return ke(e, p[t][0], r ? r[0] : n, 'minutes')
        },
        nextSlot: function(e) {
        ...
        return h.map(function(t, n) {
          ...
          return e.map(function(e, t) {
            var g = (v.get(s) || []).filter(function(t) {
                return ke(e, f.start(t), f.end(t), 'day')
              }),
  ...
  function yl(e, t, n, r, o, a) {
    ...
    var h = u ? void 0 : (l ? (c ? kc : Ha) : c ? Dc : Wa)(e)
    return (
      mc(h || e, function(r, o) {
    ...
    Pl = Rs(function(e, t) {
      ...
      for (o && _t(t[0], t[1], o) && (r = 1); ++n < r; )
        for (var a = t[n], i = Dc(a), s = -1, c = i.length; ++s < c; ) {
          var l = i[s],
            u = e[l]
          ;(void 0 === u || (Ge(u, Tl[l]) && !kl.call(e, l))) && (e[l] = a[l])
        }
      return e
    })
  var Nl = function(e) {
    ...
    return (
      ...
      (n.render = function() {
        var e = this.props,
          ...
          y = (e.components, e.formats, e.messages, e.culture, s(e, Rl))
        p = p || d()
        var b = this.getView(),
